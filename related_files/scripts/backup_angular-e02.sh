...
destination=/home/XD01/angular-e02/related_files/publication
...
destination=/home/XD01/angular-e02/related_files/publication/pub_angular-e02t02_`(date +%Y%m%d-%H%M)`.tar.gz
tar -czvf $destination $source

source=/var/www/html/d002/angular-e02t03/
destination=/home/XD01/angular-e02/related_files/publication/pub_angular-e02t03_`(date +%Y%m%d-%H%M)`.tar.gz
tar -czvf $destination $source

source=/home/XD01/angular-e02/
